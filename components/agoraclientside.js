...
let options =
{
  ...
  token: '007eJxTYPi/5P9Wme7A6qtsEqZpjx8sF5lnV5Y0MV1f+XOxmqpSbZsCg1mSkaGlpaGFkVGSoYlxqqlFYnKieZKpSUqSkbmZUZLp7xPzkxsCGRmMP9qxMDJAIIjPxBDkzMAAANi/HbA=',
  // Set the user ID.
  uid: 0,
  // Set the user role
  role: ''
...
export default agoraclientside